...
export class SchedulesComponent implements OnInit {
  ...
  goingFlight: [depart: 'goingFlightScheduleDepart', arrival: 'goingFlightScheduleArrival'] = [
    'goingFlightScheduleDepart',
    'goingFlightScheduleArrival',
  ];

  returnFlight: [depart: 'returnFlightScheduleDepart', arrival: 'returnFlightScheduleArrival'] = [
    'returnFlightScheduleDepart',
    'returnFlightScheduleArrival',
  ];
  ...
  onSelectOption(scheduleOption: IScheduleOption) {
    ...
    if (
      scheduleFilter?.get('startTime')?.value === scheduleOption.startTime ||
      scheduleFilter?.get('endTime')?.value === scheduleOption.endTime
    ) {
